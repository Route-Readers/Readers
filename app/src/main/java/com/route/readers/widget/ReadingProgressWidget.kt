...
class ReadingProgressWidget : AppWidgetProvider() {
        ...
        override fun onDeleted(context: Context, appWidgetIds: IntArray) {
            // When the last widget is deleted, delete its preferences
            for (appWidgetId in appWidgetIds) {
                WidgetConfigActivity.deleteWidgetDesign(context, appWidgetId)
            }
        }
        ...
        companion object {
            internal fun updateAppWidget(
                ...
                val selectedDesign = WidgetConfigActivity.loadWidgetDesign(context, appWidgetId)
                val layoutId = when (selectedDesign) {
                    "minimal" -> R.layout.widget_reading_progress_minimal // Will create this later
                    else -> R.layout.widget_reading_progress
                }
